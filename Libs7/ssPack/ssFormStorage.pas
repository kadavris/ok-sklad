...
uses RTLConsts, Windows, Registry, Variants, Controls, Messages, Classes, Forms, IniFiles, Dialogs, ssHook, ssAppUtil, ssProps;
...
type
  ...
  TPlacementRegRoot = (prCurrentUser, prLocalMachine, prCurrentConfig, prClassesRoot, prUsers, prDynData);
...
//-----------------------------------------------------------------------------------------
  ...
  TssFormStorage = class(TFormPlacement)
  private
...
begin
  ...
  FActive := True;
  if AOwner is TForm 
    then FOptions := [fpState, fpPosition]
    else FOptions := [];
  FWinHook := TssWindowHook.Create(Self);
...
begin
  Result := FIniSection;
  if (Result = '') and not (csDesigning in ComponentState) then Result := GetDefaultSection(Owner);
end;
...
begin
  if IniFileObject = nil then begin
    ...
    else FIniFile := TIniFile.Create(IniFileName);
  end;
end;
...
constructor TssFormStorage.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
...
destructor TssFormStorage.Destroy;
begin
  FStoredProps.Free;
  FStoredProps := nil;
  FStoredValues.Free;
...
//==============================================================================================
procedure TssFormStorage.SetNotification;
var
  I: Integer;
...
//==============================================================================================
procedure TssFormStorage.SetStoredProps(Value: TStrings);
begin
...
//==============================================================================================
procedure TssFormStorage.SetStoredValues(Value: TStoredValues);
begin
  FStoredValues.Assign(Value);
end;

//==============================================================================================
procedure TssFormStorage.Loaded;
begin
  inherited Loaded;
...
//==============================================================================================
procedure TssFormStorage.WriteState(Writer: TWriter);
begin
...
//==============================================================================================
procedure TssFormStorage.Notification(AComponent: TComponent; Operation: TOperation);
var
  I: Integer;
  Component: TComponent;
begin
...
//==============================================================================================
procedure TssFormStorage.SaveProperties;
begin
...
//==============================================================================================
procedure TssFormStorage.RestoreProperties;
begin
  with TPropsStorage.Create do
  try
    Section := IniSection;
...
//==============================================================================================
procedure TssFormStorage.SavePlacement;
begin
...
//==============================================================================================
procedure TssFormStorage.RestorePlacement;
begin
