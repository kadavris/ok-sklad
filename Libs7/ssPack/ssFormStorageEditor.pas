...
unit ssFormStorageEditor;

interface

uses
  SysUtils, Messages, Classes, Graphics, Controls, Forms, Dialogs, StdCtrls,
  Buttons, ExtCtrls, Consts, RTLConsts, DesignIntf, DesignEditors, ssFormStorage, ssProps;
...
var
  Storage: TssFormStorage;
  Opt: TPlacementOptions;
begin
  Storage := Component as TssFormStorage;
...
var
  ...
  Opt: TPlacementOptions;
begin
  Storage := GetComponent(0) as TssFormStorage;
  Opt := Storage.Options;
