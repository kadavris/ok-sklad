unit xIBConst;
// boldly converted from ibase.h by Andrej Pakhutin
...
type
  ...
  ISC_STATUS_VEC = array[0 .. ISC_STATUS_LENGTH - 1 ] of ISC_STATUS;
  PISC_STATUS_VEC= ^ISC_STATUS_VEC;

  //ISC_EXPORT = __stdcall
  //ISC_EXPORT_VARARG = __cdecl
  ...
  PISC_TEB = ^ISC_TEB;
  ISC_TEB_ARRAY = array[0..0] of ISC_TEB;
  PISC_TEB_ARRAY = ^ISC_TEB_ARRAY;

  //typedef void (*ISC_PRINT_CALLBACK) (void*, ISC_SHORT, const shortInt*);
  //typedef void (*ISC_VERSION_CALLBACK)(void*, const shortInt*);
  ...
  USER_SEC_DATA: record
      smallint sec_flags;      { which fields are specified }
      Integer uid;          { the user's id }
      Integer gid;          { the user's group id }
      Integer protocol;        { protocol to use for connection }
