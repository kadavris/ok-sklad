...
type
  TMetaClass = class
    ...
    public
      ...
      function deSerialize(const SO: TSerializator; const AMetaParent: TMetaClass = nil): Boolean;
...
//==============================================================================================
function TMetaClass.deSerialize(const SO: TSerializator; const AMetaParent: TMetaClass = nil): Boolean; // when called from descendant class
  var
    p: Integer;
begin
  Result := False;
...
begin
  ...
  SO.PutInt('mcl_ver', mclProtoVer); // !!! note the proto version constant above: mcsProtoVer !!!
  SO.PutInt('mcl_items', FItems.Count);
  //SO.EndSection;
